...
if (isset($_POST['update_profile'])) {
    ...
    if (empty($errors)) {
        ...
        if (mysqli_query($conn, $query)) {
            $_SESSION['nama'] = $nama;
            logActivity('Mengubah profil', 'users', $id_user);
...
if (isset($_POST['change_password'])) {
    ...
    if (empty($errors)) {
        ...
        if (mysqli_query($conn, $query)) {
            logActivity('Mengubah password', 'users', $id_user);
...
$stats = mysqli_fetch_assoc(mysqli_query($conn, "
    ...
    FROM pembayaran WHERE id_user = '$id_user'
"));
?>
            ...
            <div class="card shadow mb-4">
                <div class="card-body text-center">
                    <img class="img-profile rounded-circle mb-3" src="../../assets/img/undraw_profile.svg"
                        style="width: 150px;">
                    <h5 class="font-weight-bold"><?php echo htmlspecialchars($user['nama']); ?></h5>
